        ...
        given("SaveEvent") {
            `when`("saving a new event") {
                ...
                then("it should throw an exception if firestoreService add fails") {
                    ...
                    exception.message shouldBe "Failed to save entity '[new]' in subcollection '$congregationEventsSubcollectionName' under parent '${expectedParentDocumentIdForEvent}' in '$expectedParentCollectionPathForEvent'"
            ...
            `when`("saving an existing event") {
                ...
                then("it should throw an exception if firestoreService set fails") {
                    ...
                    exception.message shouldContain "Failed to save entity '${testEvent.id}' in subcollection '$congregationEventsSubcollectionName' under parent '${expectedParentDocumentIdForEvent}' in '$expectedParentCollectionPathForEvent'"
                    exception.cause?.message shouldBe errorMessage
                }
            }
        }
        ...
        given("GetEventById") {
            ...
            `when`("firestoreService fails") {
                then("it should throw an exception") {
                    ...
                    exception.message shouldContain "Failed to get entity '$testEventId' from subcollection '$congregationEventsSubcollectionName' under parent '${expectedParentDocumentIdForEvent}' in '$expectedParentCollectionPathForEvent'"
                    exception.cause?.message shouldBe errorMessage
                }
            }
        }
        ...
        given("GetAllEventsForCongregation") {
            `when`("called") {
                ...
                then("it should throw an exception if firestoreService fails") {
                    ...
                    exception.message shouldContain "Failed to get all entities from subcollection '$congregationEventsSubcollectionName' under parent '${expectedParentDocumentIdForEvent}' in '$expectedParentCollectionPathForEvent'"
                    exception.cause?.message shouldBe errorMessage
                }
            }
        }
        ...
        given("DeleteEvent") {
            `when`("deleting an event") {
                ...
                then("it should throw an exception if firestoreService fails") {
                    ...
                    exception.message shouldContain "Failed to delete entity '$testEventId' from subcollection '$congregationEventsSubcollectionName' under parent '${expectedParentDocumentIdForEvent}' in '$expectedParentCollectionPathForEvent'"
                    exception.cause?.message shouldBe errorMessage
                }
