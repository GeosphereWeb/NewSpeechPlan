        ...
        is CongregationUiState.ErrorUIState -> {
            Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    Icon(
                        imageVector = ImageVector.vectorResource(de.geosphere.speechplaning.theme.R.drawable.warning),
                ...
                floatingActionButton = {
                    if (uiState.canCreateCongregation) {
                        FloatingActionButton(onClick = { onSelectCongregation(Congregation()) }) {
                            Icon(
                                ImageVector.vectorResource(de.geosphere.speechplaning.theme.R.drawable.add),
                                contentDescription = "Add Congregation"
                            )
                        }
                    }
                }
