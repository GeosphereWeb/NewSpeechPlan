## GEOPSPHERE GENERATED
# --- Firebase Firestore ---
# Behält Klassen bei, die mit @PropertyName annotiert sind. Das ist entscheidend für Firestore-Modelle. [2]
-keepclassmembers class * {
    @com.google.firebase.firestore.PropertyName *;
}

# --- Kotlin Data Classes / POJOs für Firebase & Serialisierung ---
# Behält die Klasse, ihre Member (Felder, Methoden) und den leeren Konstruktor bei.
# Passe den Paketnamen an, falls deine Modelle woanders liegen.
-keep class de.geosphere.speechplaning.core.model.** { *; }

# --- Kotlinx Serialization ---
# Behält Klassen bei, die als @Serializable markiert sind, sowie deren Serializer. [8]
-keepclasseswithmembers class * {
    @kotlinx.serialization.Serializable <methods>;
}
-keep class * extends kotlin.jvm.internal.GeneratedSerializer { *; }

# --- Allgemeine Kotlin-Metadaten ---
# Diese Regel ist wichtig, damit Reflection-basierte Bibliotheken mit Kotlin-spezifischen
# Features korrekt funktionieren.
-keepattributes *Annotation*,Signature,Kotlin
-keep class kotlin.Metadata { *; }

# --- Koin ---
# Behält Koin-Module und interne Klassen bei, die für Reflection benötigt werden.
-keep class org.koin.** { *; }
-keep class org.koin.core.registry.*
-keep class org.koin.core.module.*
-keep class *..*Koin* { *; }
-keep class *..*Module* { *; }
# Für Koin Annotations (falls verwendet)
-keep class org.koin.core.annotation.** { *; }
## END OF GEOPSPHERE GENERATED
######
