...
class CongregationPermissionPolicy {
    ...
    fun canEdit(user: AppUser, congregation: Congregation): Boolean {
    ...
    @Suppress("UnusedParameter")
    fun canDelete(user: AppUser, congregation: Congregation): Boolean {
